...
Welcome! This repository serves as a hands-on portfolio demonstrating practical application of Governance, Risk, and Compliance (GRC) frameworks, enterprise policy development, risk assessment methodologies, and third-party risk management (TPRM).
...
### 1. [Information Security & Acceptable Use Policy](01_Acceptable_Use_Policy.md)
...
### 2. [Enterprise Incident Response Plan](02_Enterprise_Incident_Response_Plan.md)
...
### 3. [Corporate Risk Register & Dashboard](03_Risk_Register.md)
...
### 4. [Framework Control Mapping Matrix](04_Control_Mapping_Matrix.csv)
...
### 5. [Vendor Security Risk Evaluation (TPRM)](05_Vendor_Risk_Evaluation.md)
